...
function canvasApp() {
    ...
    let message = "MVRP News Headline";
    let tickermessage = "-----------MVRP Ticker-----------";
    const img = new Image();
    let imageRatio = "wide";
    ...
    function drawScreen() {
        ...
        //Logo
        const mvrpNews = document.getElementById("mvrplogo");
        ...
        context.font = "400 " + currentPos.logo.font + " Signika";
        context.fillStyle = "#fff";
        context.drawImage(mvrpNews, currentPos.logo.x, currentPos.logo.y);
        ...
        context.fillStyle = "#FFFFFF";
        context.fillText("NEWS:", currentPos.clockText.x, currentPos.clockText.y);
